...
TELEGRAM_TOKEN = "7603492076:AAHZkEJENuFHjEZLbA2FZhNRU4A2Lpv5lps"
ADMIN_CHAT_ID = 8011959413
...
# Function to get country info from BIN
...
""")
                ...
                await update.message.reply_text(f"Timeout error for card {cc}.")
